...
if __name__ == '__main__':
    ...
    verbs = verb_module.verbalise('translate Graph to English: <H> Burka Avenger <R> description <T> fictional character <H> Burka Avenger <R> instance of <T> fictional character <H> Burka Avenger <R> present in work <T> Burka Avenger <H> Burka Avenger <R> character type <T> superhero')
    print(verbs)